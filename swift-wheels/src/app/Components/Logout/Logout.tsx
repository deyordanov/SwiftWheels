                        ...
                        >
                            <Dialog.Panel className="w-full max-w-md transform overflow-hidden rounded-2xl bg-white p-6 text-left align-middle shadow-xl transition-all">
                                ...
                                <div className="mt-4">
                                    <button
                                        type="button"
                                        className="inline-flex justify-center rounded-md border border-transparent bg-accent-default px-4 py-2 text-sm font-medium text-white hover:bg-accent-hover focus:outline-none"
                                        onClick={closeModal}
                                    >
                                        Logout
                                    </button>
